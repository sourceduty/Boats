...
|
|  - Boat starts from rest in displacement mode.
|  - Engine generates thrust to propel the boat forward.
v
Bow Rise
|
|  - Boat gains speed; bow begins to rise.
|  - Stern may dig deeper, causing increased drag.
v
Transition to Planing
|
|  - Critical speed reached; hydrodynamic lift overcomes weight.
|  - Hull lifts out of water, reducing drag.
v
Planing Mode
|
|  - Hull is mostly above water; reduced wetted surface area.
|  - Significant decrease in drag allows higher speeds.
v
Stabilization
|
|  - Balance between hydrodynamic lift and gravitational forces.
|  - Speed maintained above planing threshold; operator controls throttle.
```
